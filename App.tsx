  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="MainScreen">
        ...
        <Stack.Screen name='CameraSearchScreen' component={CameraSearchScreen} />
        <Stack.Screen name='VoiceSearchScreen' component={VoiceSearchScreen} />
        <Stack.Screen name='TextSearchScreen' component={TextSearchScreen} />
        <Stack.Screen name='SearchResultListScreen' component={SearchResultListScreen} />
        <Stack.Screen
          name='MedicineDetailScreen'
          component={MedicineDetailScreen}
          options={{
            gestureEnabled: false, // 뒤로 스와이프 비활성화
            headerBackVisible: false, // 뒤로 가기 버튼 숨김
          }}
        />
      </Stack.Navigator>
    </NavigationContainer>
